...
info00 = Label(frame_left, text='Prefiltering', font=('helvetica', 12, 'italic'), justify='center', foreground='brown', background='light blue', state='disabled')
...
info03 = Label(frame_left, text='Exporting', font=('helvetica', 12, 'italic'), justify='center', foreground='brown', background='light blue', state='disabled')
info03.pack(side='top', padx=0, pady=0, fill='both')

# Export linen
butt88 = Button(frame_left, text='Export Linen...', font=('helvetica', 14), justify='center', state='disabled', command=SaveAsLinen)
butt88.pack(side='top', padx=4, pady=2, fill='both')

# Export stitch
butt89 = Button(frame_left, text='Export Stitch...', font=('helvetica', 14), justify='center', state='disabled', command=SaveAsStitch)
butt89.pack(side='top', padx=4, pady=2, fill='both')

sep04 = Separator(frame_left, orient='horizontal')
sep04.pack(side='top', pady=(0, 16), fill='both')
