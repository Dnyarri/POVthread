...
3.20.20.3   Code harmonization. Lambdas completely replaced with operators and defined functions to improve speed.
...
def filter(source_image: list[list[list[int]]], threshold_x: int, threshold_y: int, wrap_around: bool = False, keep_alpha: bool = False) -> list[list[list[int]]]:
    """Average image pixels in a row until (current - average) threshold criterion met, then repeat in a column."""
